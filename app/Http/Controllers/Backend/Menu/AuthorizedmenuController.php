...
use App\Http\Resources\AuthorizedmenuResource;
class AuthorizedmenuController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return new AuthorizedmenuResource($datas);
    }
    ...
    {
        return $Authorizedmenu = Authorizedmenu::where('show_dasboard', 1)->get();
//        $role  =   Role::all();
//        return response(['Authorizedmenu'=>$Authorizedmenu,'role' =>$role ]);
    }
}
