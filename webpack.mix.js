...
mix.js('resources/js/app.js', 'public/js')
    ...
    .copyDirectory('resources/js/assets/frontend/js', 'public/assets/frontend/js')
    .copyDirectory('resources/js/assets/frontend/fonts', 'public/assets/frontend/fonts')
...
mix.styles([
    'resources/js/assets/frontend/css/normalize.min.css',
    'resources/js/assets/frontend/css/bootstrap.min.css',
    'resources/js/assets/frontend/css/default-skin/default-skin.css',
    'resources/js/assets/frontend/css/photoswipe.css',
    'resources/js/assets/frontend/css/style.css',
    'resources/js/assets/frontend/css/reveal.css',
